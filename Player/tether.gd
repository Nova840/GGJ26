...
func _physics_process(delta: float) -> void:
	...
	tube_1.look_at(body_a.global_position)
	tube_1.scale.z = tube_1.global_position.distance_to(body_a.global_position) / tube_length
	tube_2.look_at(body_b.global_position)
	tube_2.scale.z = tube_2.global_position.distance_to(body_b.global_position) / tube_length
